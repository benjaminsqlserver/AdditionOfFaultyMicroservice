...
using CourseManagement.Middleware;
...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("CourseManagementCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration(builder.Configuration, "CourseManagement");
        ...
        // registers all services that inherit from your base service interface - ICourseManagementScopedService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(ICourseManagementScopedService)) == typeof(ICourseManagementScopedService));
