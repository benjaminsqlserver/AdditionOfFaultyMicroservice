...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<CourseManagementDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<CourseManagementDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<CourseManagementDbContext, Task<T>> action)
