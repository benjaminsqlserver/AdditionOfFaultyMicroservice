...
using CourseManagement.Extensions.Services;
using CourseManagement.Databases;
using CourseManagement.Resources;
using CourseManagement.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.CourseManagementKey] = connection;
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<CourseManagementDbContext>()
            ...
            .Options;
        var context = new CourseManagementDbContext(options, null, null, null);
