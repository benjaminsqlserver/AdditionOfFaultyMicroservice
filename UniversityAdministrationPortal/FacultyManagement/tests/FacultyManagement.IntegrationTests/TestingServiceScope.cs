...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<FacultyManagementDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<FacultyManagementDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<FacultyManagementDbContext, Task<T>> action)
