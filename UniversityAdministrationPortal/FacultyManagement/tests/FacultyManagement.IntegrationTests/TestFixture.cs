...
using FacultyManagement.Extensions.Services;
using FacultyManagement.Databases;
using FacultyManagement.Resources;
using FacultyManagement.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.FacultyManagementKey] = connection;
    ...
    {
        var options = new DbContextOptionsBuilder<FacultyManagementDbContext>()
            .UseSqlServer(connectionString)
            .Options;
        var context = new FacultyManagementDbContext(options, null, null, null);
